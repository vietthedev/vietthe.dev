...
groups inspired me and told me to give [Fresh](https://usefresh.dev/) a try. For
those who don't already know, Fresh is a web framework created by Deno. Fresh is
to Next.js as [Deno](https://deno.com/) is to Node.js. There's
